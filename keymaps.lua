...
----awesome----
    ...
    awful.key(
        {Mod,Alt}, "b", function()
            for s in screen do s.statusbar.visible = not s.statusbar.visible end end,
...
-------tag-----
   ...
   awful.key(
    ...
    awful.key(
		{Mod,Alt}, "equal",function()
			lain.util.useless_gaps_resize(1) end,
        {description = "increment useless gaps", group = "Tag"}
	),

    awful.key(
		{Mod,Alt}, "minus",function()
			lain.util.useless_gaps_resize(-1) end,
